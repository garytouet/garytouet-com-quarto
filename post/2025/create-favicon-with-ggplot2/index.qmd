...
Now, I will 1) add the text, position it, 2) remove all plot elements like grid lines and axes, 3) remove the padding that ggplot adds to the sides of the plot.
